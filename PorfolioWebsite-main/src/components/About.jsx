...
import './styles.css';
import resume from '../media/Nitesh singh Rawat fw15_087.pdf'
                  ...
                  <Col lg={4} align='center'>
                    <Card className="nbcard">
                      <Card.Body>
                        ...
                        <br></br>
                        <a href="https://www.linkedin.com/in/nitesh-singh-rawat-61a830224" target="_blank" rel="noreferrer noopener">
                           <Button variant={darkMode ? "outline-light" : "outline-dark"} className='a'>
